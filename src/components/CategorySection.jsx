...
const CategorySection = () => {
  const categories = [
    ...
    },
    {
      ...
      count: 890,
      description: 'Learn from real-world knowledge',
    },
    {
      name: 'Romance',
      image: 'https://images.unsplash.com/photo-1516975080664-ed2fc6a32937?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80',
      count: 567,
    ...
    },
    {
      ...
      count: 378,
      description: 'Journey to distant worlds',
    },
    {
      name: 'Biography',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Find your perfect book from our carefully curated categories
          </p>
        </div>
